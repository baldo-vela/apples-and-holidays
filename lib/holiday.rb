...
def all_supplies_in_holidays(holiday_hash)
  # iterate through the given holiday_hash and print items such that your readout resembles:
  # Winter:
  #   Christmas: Lights, Wreath
  ...
  holiday_hash.each do |season, holiday_with_supplies|
    ...
    holiday_with_supplies.each do |holiday, supplies|
      ...
      #takes the value from the given hash, casts it to a string and splits it at underscores
